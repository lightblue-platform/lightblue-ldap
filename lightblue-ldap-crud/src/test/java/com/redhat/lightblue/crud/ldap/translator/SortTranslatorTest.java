...
public class SortTranslatorTest {
    ...
    public void testSortKey_Desc(){
        ...
        com.unboundid.ldap.sdk.controls.SortKey[] translatedSorts = new SortTranslator(new LazyLdapFieldNameTranslator()).translate(sort);
    ...
    public void testUnsupportedSortType(){
        new SortTranslator(new LazyLdapFieldNameTranslator()).translate(new Sort(){
